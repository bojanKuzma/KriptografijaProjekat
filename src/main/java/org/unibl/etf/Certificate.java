...
public class Certificate {
    ...
    public static void saveToFile(X509Certificate certificate, String filePath) throws IOException, CertificateEncodingException {
    ...
    public static X509CRL makeV2Crl(X509Certificate caCert, PrivateKey caPrivateKey, X509Certificate revokedCertificate)
        ...
        X509CRLHolder crl = crlGen.build(new JcaContentSignerBuilder(CERT_ALGORITHM).setProvider(PROVIDER).build(caPrivateKey));
